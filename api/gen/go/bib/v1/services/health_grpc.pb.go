...
const (
	HealthService_Check_FullMethodName       = "/bib.v1.services.HealthService/Check"
	HealthService_Watch_FullMethodName       = "/bib.v1.services.HealthService/Watch"
	HealthService_GetNodeInfo_FullMethodName = "/bib.v1.services.HealthService/GetNodeInfo"
	HealthService_Ping_FullMethodName        = "/bib.v1.services.HealthService/Ping"
)
...
func (c *healthServiceClient) GetNodeInfo(ctx context.Context, in *GetNodeInfoRequest, opts ...grpc.CallOption) (*GetNodeInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetNodeInfoResponse)
	err := c.cc.Invoke(ctx, HealthService_GetNodeInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHealthServiceServer) GetNodeInfo(context.Context, *GetNodeInfoRequest) (*GetNodeInfoResponse, error) {
...
func _HealthService_GetNodeInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNodeInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HealthServiceServer).GetNodeInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HealthService_GetNodeInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).GetNodeInfo(ctx, req.(*GetNodeInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bib.v1.services.HealthService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HealthService_GetNodeInfo_Handler,
		},
		{
			MethodName: "Ping",
	...
	Metadata: "bib/v1/services/health.proto",
}
